	...
	private void initialize(Bundle _savedInstanceState) {
		...
		button1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				if (edittext1.getText().toString().equals("")) {
					FancyToast.makeText(ForgotActivity.this, "Field is empty", FancyToast.LENGTH_LONG, FancyToast.ERROR, true).show();
				}
				else {
					...
					FancyToast.makeText(ForgotActivity.this, "Please wait", FancyToast.LENGTH_LONG, FancyToast.INFO, true).show();
				}
			}
		});
		...
		_auth_reset_password_listener = new OnCompleteListener<Void>() {
			...
			public void onComplete(Task<Void> _param1) {
				final boolean _success = _param1.isSuccessful();
				if (_success) {
					FancyToast.makeText(ForgotActivity.this, "Check your email to verify your account", FancyToast.LENGTH_LONG, FancyToast.SUCCESS, true).show();
				}
			}
		};
	}
